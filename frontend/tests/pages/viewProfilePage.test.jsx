...
describe("View another user's profile", () => {
  ...
  test("user's profile picture, username, and date of creation render if no posts", async () => {
    ...
    const mockUser =
      ...
      const mockUser2 = 
      { username: "testUser2", dateCreated: "2025-04-07T14:10:05.266+00:00", profilePicture: "https://img.freepik.com/free-vector/blue-circle-with-white-user_78370-4707.jpg", email: "testEmail2", password: "2!Acebook" };        
